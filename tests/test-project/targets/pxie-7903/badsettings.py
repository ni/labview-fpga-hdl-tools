...
def pre_all(context):
    ...
    # VivadoProjectPath intentionally empty for error testing
    # config.set_vivado_project_path("")
    ...
    config.set_vivado_project_export_xpr("../../../test-labview-vpe/VivadoProject/bad_xpr_file.xpr")
